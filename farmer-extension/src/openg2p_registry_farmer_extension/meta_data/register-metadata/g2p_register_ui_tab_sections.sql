...
ON CONFLICT ("tab_section_id") DO UPDATE SET "register_id" = EXCLUDED."register_id", "tab_id" = EXCLUDED."tab_id", "section_id" = EXCLUDED."section_id", "section_order" = EXCLUDED."section_order";
